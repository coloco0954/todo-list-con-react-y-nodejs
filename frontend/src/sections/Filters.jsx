const Filters = ({ handleChangeFilter }) => {
    ...
    return (
        <section className="modal_filters hidde">
            <div className="bg-blue-chill-200 rounded-xl w-auto relative my-10 small-smartphone:w-[355px] small-tablet:w-[400px] medium-tablet:w-[500px] big-tablet:w-[600px] small-pc:w-[300px] flex flex-col">
                ...
                <h1 className="text-2xl text-center font-bold">Filtros</h1>

                <div action="" className="flex flex-col gap-y-7 px-3 py-2">
                    <label htmlFor="">
